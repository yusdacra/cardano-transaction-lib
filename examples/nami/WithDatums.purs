...
payToAlwaysSucceeds = do
  ...
  { unbalancedTx, datums: datums, redeemers } <- throwOnLeft
    =<< (Contract $ Lookups.mkUnbalancedTx' lookups constraints)
  -- let datums = Array.slice 1 100 datums_
  liftEffect $ do
    Console.log "Datums:"
    Console.log $ show datums
    Console.log "Redeemers:"
    Console.log $ show redeemers
